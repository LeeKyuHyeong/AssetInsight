// TvP 5경기 시뮬레이션 - 텍스트 확인용
// 실행: flutter test test/tvp_quick_test.dart
...
void main() {
  ...
  test('TvP 5경기 시뮬레이션 (텍스트 확인)', () async {
    print('');
    print('=' * 70);
    print('TvP 5경기: 이영호(테란 B+) vs 김택용(프로토스 B+)');
    print('맵: 파이팅스피릿');
    print('=' * 70);
    ...
    for (int i = 0; i < 5; i++) {
      ...
      if (finalState != null && finalState.homeWin != null) {
        ...
        print('');
        print('--- 경기 ${i + 1} (${finalState.homeWin! ? "테란 승" : "토스 승"}) | ${finalState.battleLog.length}줄 ---');
    ...
    print('');
    print('=' * 70);
    print('최종: 이영호(테란) $homeWins승 | 김택용(토스) $awayWins승');
    print('=' * 70);
