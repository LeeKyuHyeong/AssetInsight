// TvT 5경기 시뮬레이션 - 텍스트 확인용
// 실행: flutter test test/tvt_quick_test.dart
...
void main() {
  ...
  test('TvT 5경기 시뮬레이션 (텍스트 확인)', () async {
    print('');
    print('=' * 70);
    print('TvT 5경기: 이공격(공격형 B+) vs 박운영(운영형 B+)');
    print('맵: 파이팅스피릿');
    print('=' * 70);
    ...
    for (int i = 0; i < 5; i++) {
      ...
      if (finalState != null && finalState.homeWin != null) {
        ...
        print('');
        print('--- 경기 ${i + 1} (${finalState.homeWin! ? "이공격 승" : "박운영 승"}) | ${finalState.battleLog.length}줄 ---');
    ...
    print('');
    print('=' * 70);
    print('최종: 이공격 $homeWins승 | 박운영 $awayWins승');
    print('=' * 70);
