...
const List<MapData> allMaps = [
  ...
  MapData(
    ...
    complexity: 0.6,
    tvz: 50, zvp: 80, pvt: 0,
    description: '멀티 가깝고 방어 용이, 저그맵, 프토 극불리',
  ),
  MapData(
    name: '달의눈물',
    imageFile: '달의눈물.gif',
    ...
    resources: 0.5,
    complexity: 0.5,
    tvz: 45, zvp: 80, pvt: 33,
    description: '3인용, 입구 2개, 프토 극불리, 저그맵',
  ),
  MapData(
    name: '데스티네이션',
  ...
  MapData(
    ...
    resources: 0.6,
    complexity: 0.5,
    tvz: 52, zvp: 57, pvt: 30,
    description: '다리+중립건물, 토스 극불리',
  ),
  MapData(
    name: '로키',
    imageFile: '로키.gif',
